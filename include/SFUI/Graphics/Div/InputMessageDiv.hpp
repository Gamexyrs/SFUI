...
#include "../Button/InputDiv.hpp"
#include "MessageDiv.hpp"

namespace sf::ui {
  typedef class InputMessageDiv : public MsgDiv {
  public:    InputMessageDiv(unsigned radius = 0,
  ...
  _func_public:
    ...
    [[nodiscard]]
#endif
    // it won't be closed immediately when clicked the button in order to check the input is correct.
